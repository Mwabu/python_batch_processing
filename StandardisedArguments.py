...
def create_basic_parser(description):
    ...
    parser.add_argument('--out', nargs=1, help="The directory to output results to.")
    parser.add_argument('--in', nargs='+', action='append', help="A path to process.")
    return parser
...
def add_api_arguments(parser):
    ...
    """
    parser.add_argument('--api_url', nargs=1, help="The base api url to use.")
    parser.add_argument('--api_key', nargs=1, help="The token, or key, to send with api calls.")
...
def add_sql_server_arguments(parser):
    ...
    Return value:- the parser object that was passed in
    """
    parser.add_argument('--sql_server', nargs=1, help='the sql server to connect to')
    parser.add_argument('--sql_username', nargs=1, help='the user to connect as')
    parser.add_argument('--sql_password', nargs=1, help='the password to use')
    parser.add_argument('--sql_database', nargs=1, help='the db to access')
    return parser
...
def add_crypto_arguments(parser):
    ...
    Return value:- the parser object that was passed in
    """
    parser.add_argument('--crypto_key', nargs=1, help='The encryption key to use')
    return parser
...
def add_azure_storage_arguments(parser):
    ...
    Return value:- the parser object that was passed in
    """
    parser.add_argument('--storage_account_name', nargs=1, help='the storage account name')
    parser.add_argument('--storage_account_key', nargs=1, help='the key to access the account')
    parser.add_argument('--storage_container_name', nargs=1, help='the container to sync')
    return parser
